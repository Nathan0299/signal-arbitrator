...
exports.PriorityEvaluator = void 0;
class PriorityEvaluator {
     ...
     */
    evaluate(signal, referenceTime = Date.now(), reputationScore) {
        ...
        if (reputationScore !== undefined) {
            ...
            if (reputationScore >= 0.80)
                repCoef = 1.10;
            else if (reputationScore >= 0.60)
                repCoef = 1.00;
            else if (reputationScore >= 0.45)
                repCoef = 0.90;
            else
                repCoef = 0.00; // Crisis mode / blocked
    ...
    evaluateRule(signal, rule, deltaT) {
    ...
    evaluateBaseline(signal, deltaT) {
...
exports.PriorityEvaluator = PriorityEvaluator;
