...
exports.EntityStateStore = void 0;
class EntityStateStore {
     ...
     */
    rebuildState(entityId, entityType) {
     ...
     */
    sweepExpired(referenceTime = Date.now()) {
        const evictedSignalIds = [];
...
exports.EntityStateStore = EntityStateStore;
